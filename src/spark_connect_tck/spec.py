...
CASES = (
    ...
    TckCase(
        "TCK-WIRE-029",
        "Direct referenced SQL relations and named observation metrics preserve results and "
        "response values.",
        "SC-1.0-P1-WIRE",
        (
            "Relations / Range",
            ...
            "Relations / CollectMetrics",
            "Expressions / UnresolvedAttribute",
            "Expressions / UnresolvedFunction",
            "Expressions / Alias",
            "Result delivery / ExecutePlan observed metrics",
        ),
        ("ExecutePlan",),
    ),
    TckCase(
        "TCK-WIRE-030",
        "Direct exact nearest-by joins preserve direction, NULL-rank, top-k, tie, and "
        "outer-match semantics.",
        "SC-1.0-P1-WIRE",
        (
            "Relations / NearestByJoin",
            "Relations / LocalRelation",
            "Relations / Filter",
            "Relations / Project",
            "Relations / Sort",
    ...
    TckCase(
        "TCK-WIRE-031",
        "Direct as-of joins preserve direction, tolerance, exact-match, using-column, and "
        "outer-match semantics.",
        "SC-1.0-P1-WIRE",
        (
            "Relations / AsOfJoin",
